...
const u8 gTypeEffectiveness[750] = //[336]
{
    ...
    // NEW
    TYPE_NORMAL, TYPE_SUS, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_NORMAL, TYPE_WARCRIME, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_NORMAL, TYPE_RELIGION, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_NORMAL, TYPE_AUTISM, TYPE_MUL_NOT_EFFECTIVE,
    
    TYPE_FIGHTING, TYPE_SUS, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_FIGHTING, TYPE_GAMER, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_FIGHTING, TYPE_RELIGION, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_FIGHTING, TYPE_AUTISM, TYPE_MUL_NOT_EFFECTIVE,

    TYPE_POISON, TYPE_GAMER, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_POISON, TYPE_RELIGION, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_POISON, TYPE_AUTISM, TYPE_MUL_SUPER_EFFECTIVE,

    TYPE_GROUND, TYPE_RELIGION, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GROUND, TYPE_WARCRIME, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_GROUND, TYPE_AUTISM, TYPE_MUL_SUPER_EFFECTIVE,

    TYPE_ROCK, TYPE_WARCRIME, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_ROCK, TYPE_RELIGION, TYPE_MUL_NOT_EFFECTIVE,

    TYPE_BUG, TYPE_SUS, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_BUG, TYPE_WARCRIME, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_BUG, TYPE_AUTISM, TYPE_MUL_NOT_EFFECTIVE,

    TYPE_GHOST, TYPE_SUS, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GHOST, TYPE_GAMER, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_GHOST, TYPE_WARCRIME, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GHOST, TYPE_RELIGION, TYPE_MUL_NO_EFFECT,
    TYPE_GHOST, TYPE_AUTISM, TYPE_MUL_SUPER_EFFECTIVE,

    TYPE_STEEL, TYPE_GAMER, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_STEEL, TYPE_RELIGION, TYPE_MUL_SUPER_EFFECTIVE,

    TYPE_FIRE, TYPE_SUS, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_FIRE, TYPE_GAMER, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_FIRE, TYPE_AUTISM, TYPE_MUL_SUPER_EFFECTIVE,

    TYPE_WATER, TYPE_SUS, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_WATER, TYPE_GAMER, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_WATER, TYPE_WARCRIME, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_WATER, TYPE_AUTISM, TYPE_MUL_SUPER_EFFECTIVE,
    ...
    TYPE_GRASS, TYPE_SUS, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GRASS, TYPE_GAMER, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GRASS, TYPE_WARCRIME, TYPE_MUL_NOT_EFFECTIVE,

    TYPE_ELECTRIC, TYPE_SUS, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_ELECTRIC, TYPE_GAMER, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_ELECTRIC, TYPE_RELIGION, TYPE_MUL_SUPER_EFFECTIVE,

    TYPE_PSYCHIC, TYPE_SUS, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_PSYCHIC, TYPE_GAMER, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_PSYCHIC, TYPE_WARCRIME, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_PSYCHIC, TYPE_AUTISM, TYPE_MUL_SUPER_EFFECTIVE,

    TYPE_ICE, TYPE_SUS, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_ICE, TYPE_WARCRIME, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_ICE, TYPE_RELIGION, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_ICE, TYPE_AUTISM, TYPE_MUL_NOT_EFFECTIVE,

    TYPE_DRAGON, TYPE_SUS, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_DRAGON, TYPE_WARCRIME, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_DRAGON, TYPE_AUTISM, TYPE_MUL_NOT_EFFECTIVE,

    TYPE_DARK, TYPE_SUS, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_DARK, TYPE_WARCRIME, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_DARK, TYPE_RELIGION, TYPE_MUL_NO_EFFECT,
    TYPE_DARK, TYPE_AUTISM, TYPE_MUL_NOT_EFFECTIVE,

    TYPE_SUS, TYPE_NORMAL, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_SUS, TYPE_GROUND, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_SUS, TYPE_ROCK, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_SUS, TYPE_BUG, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_SUS, TYPE_GHOST, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_SUS, TYPE_STEEL, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_SUS, TYPE_GRASS, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_SUS, TYPE_PSYCHIC, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_SUS, TYPE_DRAGON, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_SUS, TYPE_DARK, TYPE_MUL_NO_EFFECT,
    TYPE_SUS, TYPE_GAMER, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_SUS, TYPE_RELIGION, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_SUS, TYPE_AUTISM, TYPE_MUL_SUPER_EFFECTIVE,

    TYPE_GAMER, TYPE_NORMAL, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GAMER, TYPE_FIGHTING, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_GAMER, TYPE_POISON, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_GAMER, TYPE_GROUND, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_GAMER, TYPE_ROCK, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_GAMER, TYPE_BUG, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_GAMER, TYPE_GHOST, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GAMER, TYPE_STEEL, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GAMER, TYPE_WATER, TYPE_MUL_NO_EFFECT,
    TYPE_GAMER, TYPE_GRASS, TYPE_MUL_NO_EFFECT,
    TYPE_GAMER, TYPE_ELECTRIC, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GAMER, TYPE_PSYCHIC, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GAMER, TYPE_ICE, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_GAMER, TYPE_DRAGON, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_GAMER, TYPE_DARK, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GAMER, TYPE_SUS, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_GAMER, TYPE_GAMER, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_GAMER, TYPE_WARCRIME, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_GAMER, TYPE_RELIGION, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GAMER, TYPE_AUTISM, TYPE_MUL_SUPER_EFFECTIVE,

    TYPE_WARCRIME, TYPE_NORMAL, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_WARCRIME, TYPE_GROUND, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_WARCRIME, TYPE_ROCK, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_WARCRIME, TYPE_BUG, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_WARCRIME, TYPE_GHOST, TYPE_MUL_NO_EFFECT,
    TYPE_WARCRIME, TYPE_WATER, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_WARCRIME, TYPE_GRASS, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_WARCRIME, TYPE_ELECTRIC, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_WARCRIME, TYPE_PSYCHIC, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_WARCRIME, TYPE_ICE, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_WARCRIME, TYPE_DARK, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_WARCRIME, TYPE_SUS, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_WARCRIME, TYPE_GAMER, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_WARCRIME, TYPE_WARCRIME, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_WARCRIME, TYPE_RELIGION, TYPE_MUL_NO_EFFECT,
    TYPE_WARCRIME, TYPE_AUTISM, TYPE_MUL_SUPER_EFFECTIVE,

    TYPE_RELIGION, TYPE_NORMAL, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_RELIGION, TYPE_FIGHTING, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_RELIGION, TYPE_POISON, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_RELIGION, TYPE_GROUND, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_RELIGION, TYPE_ROCK, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_RELIGION, TYPE_BUG, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_RELIGION, TYPE_GHOST, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_RELIGION, TYPE_STEEL, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_RELIGION, TYPE_WATER, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_RELIGION, TYPE_ELECTRIC, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_RELIGION, TYPE_PSYCHIC, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_RELIGION, TYPE_ICE, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_RELIGION, TYPE_DARK, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_RELIGION, TYPE_SUS, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_RELIGION, TYPE_GAMER, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_RELIGION, TYPE_WARCRIME, TYPE_MUL_NO_EFFECT,
    TYPE_RELIGION, TYPE_RELIGION, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_RELIGION, TYPE_AUTISM, TYPE_MUL_NOT_EFFECTIVE,

    TYPE_AUTISM, TYPE_NORMAL, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_AUTISM, TYPE_FIGHTING, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_AUTISM, TYPE_POISON, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_AUTISM, TYPE_GROUND, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_AUTISM, TYPE_BUG, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_AUTISM, TYPE_GHOST, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_AUTISM, TYPE_FIRE, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_AUTISM, TYPE_WATER, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_AUTISM, TYPE_PSYCHIC, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_AUTISM, TYPE_DRAGON, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_AUTISM, TYPE_WARCRIME, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_AUTISM, TYPE_RELIGION, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_AUTISM, TYPE_AUTISM, TYPE_MUL_SUPER_EFFECTIVE,
...
const u8 gTypeNames[NUMBER_OF_MON_TYPES][TYPE_NAME_LENGTH + 1] =
{
    ...
    [TYPE_SUS] = _("SUS"),
    [TYPE_GAMER] = _("GAMER"),
    [TYPE_WARCRIME] = _("WARCRM"),
    [TYPE_RELIGION] = _("RELIGN"),
    [TYPE_AUTISM] = _("AUTISM"),
    [TYPE_SHEDINJA] = _("SHEDJA"),
};
