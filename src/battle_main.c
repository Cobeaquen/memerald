...
const u8 gTypeEffectiveness[750] = //[336]
{
    ...
    TYPE_NORMAL, TYPE_AUTIST, TYPE_MUL_NOT_EFFECTIVE,
    ...
    TYPE_BUG, TYPE_AUTIST, TYPE_MUL_NOT_EFFECTIVE,
    ...
    TYPE_GHOST, TYPE_AUTIST, TYPE_MUL_SUPER_EFFECTIVE,
    ...
    TYPE_FIRE, TYPE_AUTIST, TYPE_MUL_SUPER_EFFECTIVE,
    ...
    TYPE_WATER, TYPE_AUTIST, TYPE_MUL_SUPER_EFFECTIVE,
    ...
    TYPE_PSYCHIC, TYPE_AUTIST, TYPE_MUL_SUPER_EFFECTIVE,
    ...
    TYPE_DARK, TYPE_AUTIST, TYPE_MUL_NOT_EFFECTIVE,
    ...
    TYPE_SUS, TYPE_AUTIST, TYPE_MUL_SUPER_EFFECTIVE,
    ...
    TYPE_GAMER, TYPE_AUTIST, TYPE_MUL_SUPER_EFFECTIVE,
    ...
    TYPE_WARCRIME, TYPE_AUTIST, TYPE_MUL_SUPER_EFFECTIVE,
    ...
    TYPE_RELIGION, TYPE_AUTIST, TYPE_MUL_NOT_EFFECTIVE,

    TYPE_AUTIST, TYPE_NORMAL, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_AUTIST, TYPE_FIGHTING, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_AUTIST, TYPE_POISON, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_AUTIST, TYPE_GROUND, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_AUTIST, TYPE_BUG, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_AUTIST, TYPE_GHOST, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_AUTIST, TYPE_FIRE, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_AUTIST, TYPE_WATER, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_AUTIST, TYPE_PSYCHIC, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_AUTIST, TYPE_DRAGON, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_AUTIST, TYPE_WARCRIME, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_AUTIST, TYPE_RELIGION, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_AUTIST, TYPE_AUTIST, TYPE_MUL_SUPER_EFFECTIVE,
...
const u8 gTypeNames[NUMBER_OF_MON_TYPES][TYPE_NAME_LENGTH + 1] =
{
    ...
    [TYPE_SUS] = _("SUS"),
    [TYPE_GAMER] = _("GAMER"),
    [TYPE_WARCRIME] = _("WARCRIME"),
    [TYPE_RELIGION] = _("RELIGION"),
    [TYPE_AUTIST] = _("AUTIST"),
};
