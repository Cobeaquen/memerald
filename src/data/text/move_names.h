const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_BATON_PASS] = _("ACQUIRE SIRE"),
    ...
    [MOVE_SUGMA] = _("SUGMA"),
    [MOVE_GOATSEE] = _("GOATSEE"),
    [MOVE_GOONING] = _("GOONING"),
    [MOVE_WHIP] = _("WHIP"),
    [MOVE_ROOFIE] = _("ROOFIE"),
    [MOVE_GLAZING] = _("GLAZING"),
    [MOVE_SNM] = _("SNM"),
    [MOVE_MYSTERY_GOO] = _("MYSTERY GOO"),
    [MOVE_RED_ROOM] = _("RED ROOM"),
    [MOVE_EJECT] = _("EJECT"),
    [MOVE_SABOTAGE] = _("SABOTAGE"),
    [MOVE_GASLIGHT] = _("GASLIGHT"),
    [MOVE_CBT] = _("C&B TORTURE"),
    [MOVE_MEDTM] = _("MONSTERTM"),
    [MOVE_CNTRLR_SPIKE] = _("CNTRLR SPIKE"),
    [MOVE_MALDING] = _("MALDING"),
    [MOVE_DESTROY] = _("DESTROY"),
    [MOVE_MAIDENLESS] = _("MAIDENLESS"),
    [MOVE_360_NOSCOPE] = _("360 NOSCOPE"),
    [MOVE_FLAME] = _("FLAME"),
    [MOVE_RACISM] = _("RACISM"),
    [MOVE_COOKIELOL] = _("COOKIELOL"),
    [MOVE_APE_MODE] = _("APE MOVE"),
    [MOVE_THE_VOICES] = _("THE VOICES"),
    [MOVE_PROGAMERMOVE] = _("PROGAMERMOVE"),
    [MOVE_PRAYER] = _("PRAYER"),
    [MOVE_MOLEST] = _("MOLEST"),
    [MOVE_CRUSADE] = _("CRUSADE"),
    [MOVE_FLOODING] = _("FLOODING"),
    [MOVE_BELIEF] = _("BELIEF"),
    [MOVE_CONVERT] = _("CONVERT"),
    [MOVE_SOF] = _("SOF"),
    [MOVE_LULLABY] = _("LULLABY"),
    [MOVE_CRUCIFIXION] = _("CRUCIFIXION"),
    [MOVE_RESURRECT] = _("RESURRECT"),
    [MOVE_DISPEL_CURSE] = _("DISPEL CURSE"),
    [MOVE_SWARM_O_BUGS] = _("SWARM O BUGS"),
    [MOVE_BOMBING] = _("BOMBING"),
    [MOVE_TORTURE] = _("TORTURE"),
    [MOVE_OBAMA] = _("OBAMA"),
    [MOVE_INVASION] = _("INVASION"),
    [MOVE_INVADE] = _("INVADE"),
    [MOVE_SHOWER_TIME] = _("SHOWER TIME"),
    [MOVE_GULAG] = _("GULAG"),
    [MOVE_MANSLAUGHTER] = _("MANSLAUGHTER"),
    [MOVE_GUN] = _("GUN"),
    [MOVE_EXECUTION] = _("EXECUTION"),
    [MOVE_9_11] = _("9/11"),
    [MOVE_ASSASSINATE] = _("ASSASSINATE"),
    [MOVE_DRONE_STRIKE] = _("DRONE STRIKE"),
    [MOVE_PERFECTIONST] = _("PERFECTIONST"),
    [MOVE_PATTERN] = _("PATTERN"),
    [MOVE_QUICK_MATHS] = _("QUICK MATHS"),
    [MOVE_FREAK_OUT] = _("FREAK OUT"),
    [MOVE_UNSTABLE] = _("UNSTABLE"),
    [MOVE_SHUTDOWN] = _("SHUTDOWN"),
    [MOVE_STATIC] = _("STATIC"),
    [MOVE_ANXIETY] = _("ANXIETY"),
    [MOVE_THE_SPECTRUM] = _("THE SPECTRUM"),
    [MOVE_ANTI_SOCIAL] = _("ANTI SOCIAL"),
    [MOVE_HYPER_FIXATE] = _("HYPER FIXATE"),
    [MOVE_ROCKETLEAGUE] = _("ROCKETLEAGUE"),
    [MOVE_UNO_REVERSE] = _("UNO REVERSE"),
    [MOVE_STUTTER] = _("STUTTER"),
};
